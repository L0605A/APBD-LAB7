...
public class WarehouseController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> AddProduct(DTOWarehouseQuerry warehouseQuerry)
    {
        ...
        using (SqlConnection connection = new SqlConnection(connectionString))
        {
            ...
            try
            {
                    ...
                    transaction))
                {
                    ...
                    object warehouseResult = await warehouseCommand.ExecuteScalarAsync();
                    ...
                    transaction))
                {
                    ...
                    orderId = (int?)await orderCommand.ExecuteScalarAsync() ?? 0;
                    ...
                    transaction))
                {
                    ...
                    price = (decimal?)await priceCommand.ExecuteScalarAsync() ?? 0;
